...
const docTemplate = `{
    ...
    "components": {"schemas":{"main.APIError":{"properties":{"error":{"type":"string"}},"type":"object"},"main.APISuccess":{"properties":{"result":{"type":"number"}},"type":"object"},"main.Payload":{"properties":{"number1":{"example":6,"type":"number"},"number2":{"example":9,"type":"number"}},"type":"object"}}},
