...
const docTemplate = `{
    ...
    "info": {"contact":{"email":"pa.ndoye@outlook.com","name":"Abdoulaye NDOYE","url":"https://github.com/NDOY3M4N"},"description":"{{escape .Description}}","license":{"name":"MIT","url":"https://github.com/NDOY3M4N/api-calculator/blob/main/LICENSE"},"title":"{{.Title}}","version":"{{.Version}}"},
